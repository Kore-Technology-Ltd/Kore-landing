...
export default function WhyDifferent() {
  ...
  return (
    <section
      ref={reveal.ref}
      id="section-why-kore"
      className={`why-different ${reveal.className}`}
    >
      ...
      >
        ...
        >
          ...
          <div className="why-different__card why-different__card--escrow">
            ...
            <span className="why-different__card-body">
              Secure transactions with payment held until delivery confirmed.
              Both parties protected. Building an economy on trust, not fear.
              <br />
            </span>
          </div>
          ...
          <div className="why-different__card why-different__card--pricing">
            <div className="why-different__card-header why-different__card-header--pricing">
              ...
              <div className="why-different__card-titles">
                ...
                <span className="why-different__card-subtitle">
                  For Everyone
                </span>
              </div>
            </div>
            <span className="why-different__card-body why-different__card-body--right">
              Dynamic pricing based on freshness status. Farmers earn more.
              Buyers pay less. Transparency ensures everyone wins.
              <br />
            </span>
          </div>
