      ...
      <div className="legal-body-container">
        ...
        <main className="legal-content-card">
          <div className="legal-intro-box">
            ...
            2020, collects, uses, stores, and protects your personal data when
            you use our digital marketplace platform at <strong>kore.ng</strong>{' '}
            ("the Platform"). This Policy is issued in compliance with the{' '}
            <strong>Nigeria Data Protection Act 2023 (NDPA)</strong> and the
            regulations of the{' '}
            <strong>Nigeria Data Protection Commission (NDPC)</strong>. By using
            the Platform, you consent to the collection and use of your personal
          ...
          <section id="sec-1" className="legal-section-block">
            ...
            <div className="legal-info-card">
              ...
              <div className="legal-info-card-text">
                RC Number: 9614851
                <br />
                Address: 65, BQ Soweto UCH, Ibadan, Oyo State, Federal Republic
                of Nigeria
                <br />
            ...
            <p>
              We are registered with the Nigeria Data Protection Commission
              (NDPC) as a Data Controller. Our Data Protection Officer (DPO) can
              be reached at <a href="mailto:privacy@kore.ng">privacy@kore.ng</a>
              .
            </p>
          </section>
          ...
          <section id="sec-2" className="legal-section-block">
            ...
            <p>
              We collect personal data only where it is necessary for a
              legitimate purpose. The categories of personal data we collect
              include:
            </p>
            ...
            <div className="legal-sub-section">
              ...
              <ul>
                ...
                <li>
                  National Identification Number (NIN) or Bank Verification
                  Number (BVN) — for Seller identity verification only;
                </li>
                <li>CAC business registration number (Sellers);</li>
                <li>
                  Bank account details (for payment disbursement to Sellers);
                </li>
                <li>
                ...
                <li>
                  Communications sent to us via email, WhatsApp, or the
                  Platform's messaging system; and
                </li>
                <li>
            ...
            <div className="legal-sub-section">
              ...
              <ul>
                ...
                <li>
                  Pages visited, time spent on the Platform, and click-through
                  data;
                </li>
                <li>
          ...
          <section id="sec-3" className="legal-section-block">
            ...
            <ul>
              ...
              <li>
                ...
                informed, and unambiguous consent (e.g., marketing
                communications, optional analytics).
              </li>
              <li>
                <strong>Legal Obligation:</strong> Where processing is required
                to comply with applicable Nigerian law (e.g., FIRS tax
                reporting, NDPC registration, EFCC/NFIU anti-money laundering
                requirements).
              </li>
              <li>
                <strong>Legitimate Interests:</strong> Where necessary for our
                legitimate business interests (fraud prevention, Platform
                security, product improvement), provided these interests are not
          ...
          <section id="sec-4" className="legal-section-block">
            ...
            <ul>
              ...
              <li>
                <strong>Transaction Processing:</strong> Processing orders,
                managing escrow payments, disbursing funds to Sellers, and
                issuing refunds to Buyers;
              </li>
              <li>
                <strong>Identity Verification:</strong> Verifying the identity
                and credentials of Sellers to maintain a trusted marketplace;
              </li>
              <li>
              ...
              <li>
                <strong>Communications:</strong> Sending transactional
                notifications (order confirmations, payment receipts, dispute
                updates) and — with your consent — promotional communications;
              </li>
              <li>
              ...
              <li>
                ...
                Nigerian law, including FIRS tax reporting, anti-money
                laundering (AML) obligations under the Money Laundering
                Prevention and Prohibition Act 2022, and data protection
                compliance under the NDPA 2023; and
              </li>
              <li>
          ...
          <section id="sec-5" className="legal-section-block">
            ...
            <p>
              ...
              your personal data with the following categories of third parties
              only where necessary and on a need-to-know basis:
            </p>
            <ul>
              <li>
                <strong>Payment Processors:</strong> Paystack and/or
                Flutterwave, for the processing of escrow payments, refunds, and
                disbursements. These processors are bound by their own privacy
                policies and applicable CBN regulations;
              </li>
              <li>
                <strong>Logistics Partners:</strong> Third-party delivery
                companies integrated into the Platform, who receive the delivery
                address and order details necessary to complete a delivery;
              </li>
              <li>
                <strong>Identity Verification Providers:</strong> Third-party
                KYC providers used to verify Seller identities, who receive only
                the minimum data necessary for verification;
              </li>
              <li>
                <strong>Cloud Service Providers:</strong> Infrastructure
                providers (including Supabase and cloud hosting services) that
                host the Platform and its data, who process data under
                appropriate data processing agreements;
              </li>
              <li>
                <strong>Legal and Regulatory Authorities:</strong> Where
                required by Nigerian law, court order, or regulatory authority
                (including NDPC, FIRS, EFCC, NFIU, or law enforcement), we may
                disclose personal data without prior notice to you; and
              </li>
              <li>
                <strong>Professional Advisors:</strong> Legal counsel,
                accountants, and auditors, subject to professional
                confidentiality obligations.
              </li>
            </ul>
            <p>
              Where we share data with any third party acting as a Data
              Processor on our behalf, we ensure a data processing agreement is
              in place that requires them to protect your data in accordance
              with the NDPA 2023.
            </p>
          </section>
          ...
          <section id="sec-6" className="legal-section-block">
            ...
            <p>
              ...
              Nigerian law. Our standard retention periods are as follows:
            </p>
            ...
            <p>
              ...
              deleted or anonymised so that it can no longer be associated with
              you.
            </p>
          </section>
          ...
          <section id="sec-7" className="legal-section-block">
            ...
            <ul>
              ...
              <li>
                ...
                may request deletion of your personal data, subject to our legal
                retention obligations;
              </li>
              <li>
                <strong>Right to Restriction of Processing:</strong> You may
                request that we restrict the processing of your data in certain
                circumstances;
              </li>
              <li>
            ...
            <p>
              ...
              to <a href="mailto:privacy@kore.ng">privacy@kore.ng</a>. We will
              respond within <strong>30 days</strong> of receiving a verifiable
              request. You also have the right to lodge a complaint with the{' '}
          ...
          <section id="sec-8" className="legal-section-block">
            ...
            <ul>
              ...
              <li>
                Role-based access controls limiting staff access to personal
            ...
            <p>
              ...
              a high risk to your rights and freedoms, we will notify you and
              the NDPC within <strong>72 hours</strong> of becoming aware of the
          ...
          <section id="sec-9" className="legal-section-block">
            ...
            <p>
              ...
              improve your experience. We use the following types of cookies:
            </p>
            <ul>
              <li>
                <strong>Essential Cookies:</strong> Required for the Platform to
                function (authentication, session management, cart/escrow
            ...
            <p>
              ...
              settings or through our cookie consent banner. Disabling
              non-essential cookies will not affect your ability to use core
              Platform features.
            </p>
          </section>
          ...
          <section id="sec-10" className="legal-section-block">
            ...
            <p>
              The Korè Platform is not directed at children under the age of 18.
              ...
              minor without verifiable parental consent, we will take immediate
              steps to delete that information. If you believe we may have
          ...
          <section id="sec-11" className="legal-section-block">
            ...
            <p>
              Where we transfer personal data outside Nigeria (for example, to
              cloud infrastructure providers or payment processors with servers
              outside Nigeria), we ensure that such transfers comply with the
              NDPA 2023. We transfer data only to countries or organisations
              that provide an adequate level of data protection, or where
              appropriate safeguards (such as data transfer agreements) are in
              place.
            </p>
          </section>
          ...
          <section id="sec-12" className="legal-section-block">
            ...
            <p>
              ...
              (including logistics partners, payment processors, and social
              media platforms). This Privacy Policy applies only to the Korè
              Platform. We are not responsible for the privacy practices of any
          ...
          <section id="sec-13" className="legal-section-block">
            ...
            <p>
              ...
              Platform. You may opt out of marketing communications at any time
              by clicking "Unsubscribe" in any email, or by contacting us at{' '}
              <a href="mailto:info@kore.ng">info@kore.ng</a>. Opting out of
              marketing communications will not affect transactional
              notifications (such as order confirmations and payment receipts),
          ...
          <section id="sec-14" className="legal-section-block">
            ...
            <p>
              ...
              changes in our practices, technology, or applicable law. Where
              changes are material, we will notify you by email or through a
              prominent notice on the Platform at least 14 days before the
              updated Policy takes effect. Your continued use of the Platform
          ...
          <section id="sec-15" className="legal-section-block">
            ...
            <p>
              For any privacy-related enquiries, requests to exercise your
