  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 2. Chat with us WhatsApp button (Desktop Only) */}
        <a
          href="https://wa.me/2349021204151"
          target="_blank"
          rel="noopener noreferrer"
          className="footer__chat-button-wrapper footer__chat-button-wrapper--desktop"
        >
        ...
        <div className="footer__top-container">
          ...
          <nav className="footer__links" aria-label="Footer links">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="footer__chat-button-wrapper footer__chat-button-wrapper--mobile"
            >
              <div className="footer__chat-button">
                <span className="footer__chat-text">Chat with us</span>
              </div>
